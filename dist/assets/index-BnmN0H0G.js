import{c as C,r as O,e as P,n as h,a as b,i as E,b as g,H as S,I as R,U as I,g as L,h as _,J as f,R as k,u as x,j as c,o as A,S as T,G as v}from"./index-DHWSxavf.js";const D=C`
  :host {
    position: relative;
...
`;var y=function(n,t,e,i){var s=arguments.length,o=s<3?t:i===null?i=Object.getOwnPropertyDescriptor(t,e):i,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(n,t,e,i);else for(var a=n.length-1;a>=0;a--)(r=n[a])&&(o=(s<3?r(o):s>3?r(t,e,o):r(t,e))||o);return s>3&&o&&Object.defineProperty(t,e,o),o};let p=class extends E{constructor(){super(...arguments),this.disabled=!1,this.value=""}render(){return g`<input
      ...
      value=${this.value}
    /> `}};p.styles=[O,P,D];y([h({type:Boolean})],p.prototype,"disabled",void 0);y([h({type:String})],p.prototype,"value",void 0);p=y([b("wui-input-numeric")],p);const F=S`
  :host {
    position: relative;
    display: block;
  }
